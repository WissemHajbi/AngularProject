...
@NgModule({
  declarations: [AppComponent, HomeComponent, LoginComponent, DoctorListComponent, DoctorCreateComponent, DoctorEditComponent, PatientListComponent, PatientCreateComponent, AppointmentListComponent, DashboardComponent],
